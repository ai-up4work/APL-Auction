...
import SectionDivider from "@/components/tournament/section-divider"
...
The user interface incorporates nautical elements like aged parchment, compasses, and spyglasses, enhancing the immersive pirate theme. Battle animations are fluid and spectacular, with cannon fire, splashing water, and splintering wood creating dynamic combat scenarios.`,
    ...
    const mockGame = {
      ...
      image: "/images/games/mock-game.png",
      description: "This is a mock game description for testing purposes.",
      longDescription:
        "This is a longer mock game description that provides more details about the game, its features, and gameplay mechanics. It is used for testing the game detail page layout and functionality.",
      slug: "mock-game",
      rating: 4.5,
      platforms: ["PC", "PlayStation 5"],
      genres: ["Action", "Adventure"],
      features: ["Multiplayer", "Single Player", "Co-op"],
      gameplay: "Fast-paced action with strategic combat mechanics.",
      visuals: "High-definition graphics with detailed environments.",
    }
