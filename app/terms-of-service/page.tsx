    ...
    <main className="overflow-hidden">
      ...
      <section className="pt-32 sm:pt-40 pb-16 relative section-pattern">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <div className="max-w-4xl mx-auto bg-black/50 border border-gold/20 rounded-lg p-8 md:p-12 glow-effect fade-in-up">
            ...
            <div className="space-y-6 text-gray-300">
              <p>
                <strong className="text-white">Last Updated:</strong> April 1, 2025
              </p>

              <h2 className="text-xl font-bold text-white mt-8 mb-4 font-cinzel">1. Acceptance of Terms</h2>
              <p>
              ...
              <h2 className="text-xl font-bold text-white mt-8 mb-4 font-cinzel">2. Changes to Terms</h2>
              <p>
              ...
              <h2 className="text-xl font-bold text-white mt-8 mb-4 font-cinzel">3. Services Description</h2>
              <p>
              ...
              <ul className="list-disc pl-6 space-y-2 mt-2 marker:text-gold">
              ...
              <h2 className="text-xl font-bold text-white mt-8 mb-4 font-cinzel">4. User Accounts and Registration</h2>
              <p>
              ...
              <h2 className="text-xl font-bold text-white mt-8 mb-4 font-cinzel">5. User Conduct</h2>
              ...
              <h2 className="text-xl font-bold text-white mt-8 mb-4 font-cinzel">6. Intellectual Property</h2>
              <p>
              ...
              <h2 className="text-xl font-bold text-white mt-8 mb-4 font-cinzel">7. Third-Party Links and Services</h2>
              <p>
              ...
              <h2 className="text-xl font-bold text-white mt-8 mb-4 font-cinzel">8. Limitation of Liability</h2>
              <p>
              ...
              <h2 className="text-xl font-bold text-white mt-8 mb-4 font-cinzel">9. Disclaimer of Warranties</h2>
              <p>
              ...
              <h2 className="text-xl font-bold text-white mt-8 mb-4 font-cinzel">10. Termination of Service</h2>
              <p>
                In our sole discretion, services may be terminated with 30 days written notice to the user. The user may
              ...
              <h2 className="text-xl font-bold text-white mt-8 mb-4 font-cinzel">11. Governing Law</h2>
              <p>
              ...
              <h2 className="text-xl font-bold text-white mt-8 mb-4 font-cinzel">12. Dispute Resolution</h2>
              <p>
              ...
              <h2 className="text-xl font-bold text-white mt-8 mb-4 font-cinzel">13. Severability</h2>
              <p>
              ...
              <h2 className="text-xl font-bold text-white mt-8 mb-4 font-cinzel">14. Contact Us</h2>
              <p>If you have any questions about these Terms, please contact us at:</p>
              <p className="mt-2">
                Email:{" "}
                <a href="mailto:thewardensgc@gmail.com" className="text-gold hover:underline">
                  thewardensgc@gmail.com
                </a>
              </p>
              <p>
                Discord:{" "}
