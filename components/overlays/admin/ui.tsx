...
// ── Icon action button — used for the FOUR/SIX/WICKET style controls ──
export function ActionButton({
  ...
  return (
    <button
      ...
      style={{
        fontFamily: "var(--font-label-mono)",
        background: active ? `${accent}22` : hovered ? `${accent}10` : "var(--color-surface-container-low)",
        border: `1px solid ${active ? `${accent}66` : "var(--color-border-overlay)"}`,
        color: active || hovered ? accent : "var(--color-on-surface-variant)",
      }}
    >
      {icon && (
